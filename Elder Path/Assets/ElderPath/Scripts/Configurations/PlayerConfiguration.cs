...
public class PlayerConfiguration : ScriptableObject {
    ...
    [field: SerializeField] public float JumpTimeToApex { get; private set; }
    ...
    private void OnValidate() {
        GravityForce = -(2 * JumpHeight) / (JumpTimeToApex * JumpTimeToApex);
        JumpForce = Mathf.Abs(GravityForce) * JumpTimeToApex;
    }
}